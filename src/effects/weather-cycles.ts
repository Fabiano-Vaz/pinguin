...
(() => {
  ...
  const weatherSpaceEvents =
    typeof effectModules.weatherSpaceEvents === "function"
      ? effectModules.weatherSpaceEvents({ effects, isRaining, isSnowing })
      : {};

  const clearRainLightningCycle =
    typeof weatherSpaceEvents.clearRainLightningCycle === "function"
      ? weatherSpaceEvents.clearRainLightningCycle.bind(weatherSpaceEvents)
      : () => {};
  const scheduleRainLightningCycle =
    typeof weatherSpaceEvents.scheduleRainLightningCycle === "function"
      ? weatherSpaceEvents.scheduleRainLightningCycle.bind(weatherSpaceEvents)
      : () => {};
  const triggerShootingStarEvent =
    typeof weatherSpaceEvents.triggerShootingStarEvent === "function"
      ? weatherSpaceEvents.triggerShootingStarEvent.bind(weatherSpaceEvents)
      : () => {};
  const startShootingStarCycle =
    typeof weatherSpaceEvents.startShootingStarCycle === "function"
      ? weatherSpaceEvents.startShootingStarCycle.bind(weatherSpaceEvents)
      : () => {};
  const stopShootingStarCycle =
